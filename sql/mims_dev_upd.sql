...
CREATE TABLE `upd` (
  ...
  PRIMARY KEY (`updid`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='更新日志';
...
-- Dump completed on 2018-02-01 10:28:59
