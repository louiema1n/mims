...
CREATE TABLE `upd` (
  ...
  PRIMARY KEY (`updid`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='更新日志';
...
-- Dump completed on 2018-01-01 21:30:23
