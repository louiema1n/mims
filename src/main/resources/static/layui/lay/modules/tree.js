...
;layui.define("jquery", function (e) {
    ...
    r.prototype.init = function (e) {
    ...
    }, r.prototype.click = function (e, oo) {
        var a = this,
            r = a.options;
        e.children("a").on("click",
            function (e) {
                layui.stope(e),
                    r.click(oo);
                o(r.elem).find("a").removeAttr("style").find("i").removeAttr("style");
                var t = e.target;
                if (o(t).is("cite") || o(t).is("i")) {
                    t.parentNode.style.backgroundColor = "#f2f2f2";
                    // t.parentNode.style.fontWeight = "bold";
                    t.parentNode.firstChild.style.color = "#009688";
                    t.parentNode.style.color = "#009688";
                }
                //e.target.parent().css("background-color", "#f00");
            })
